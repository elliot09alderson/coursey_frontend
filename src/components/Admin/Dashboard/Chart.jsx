...
export  const LineChart = () => {
    ...
    const data={
        labels,
        datasets:[{label:"Views",data:[1,2,3,4,5],borderColor:"rgba(107,70,193,0.5)",backgroundColor:'#6b46c1'}]
    }
...
const currentMonth = new Date().getMonth(); // 0
const remain = 11-currentMonth; // 11
// console.log(remain)
